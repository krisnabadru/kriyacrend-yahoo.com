...
<head>
    ...
    <meta name="description" content="Produk By Krisna Badru">
    <meta name="author" content="Krisna Badru">

    <title>TOKO KRIYA</title>
...
<body>
<img src="<?php echo base_url().'assets/img/bgfantasy.jpg'?>" alt="gambar" class="bg" />
    <!-- Navigation -->
   <?php 
   ...
   ?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header" style="color:#ff0000;">TOKO KRIYA
